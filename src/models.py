...
#Models fitting
# --------------------------------------------------------------------
# 1 A registry that maps a short key → a scikit‑learn estimator
# --------------------------------------------------------------------
...
# --------------------------------------------------------------------
# 2 The core routine – pure modelling + optional hyper‑parameter search
# --------------------------------------------------------------------
def fit_model(
    ...
    *,
    ...
    return_metrics : bool
        ...
        RMSE and R² on the *test* set (you need to supply `y_test`
    ...
    metrics : dict | None
        If `return_metrics=True` - a small dict of RMSE and R².
    """
    ...
    # ---- 2b. Default hyperparameter grids ---------------------------------
